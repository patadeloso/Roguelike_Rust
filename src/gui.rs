...
use specs::prelude::*;
use super::{CombatStats, Player, gamelog::GameLog, Position, Map, Name, State, InBackpack};
...
pub fn draw_ui(ecs: &World, ctx: &mut Rltk) {
  ...
  for (_player, stats) in (&players, &combat_stats).join() {
      ...
      ctx.draw_bar_horizontal(28, 42, 51, stats.hp, stats.max_hp, RGB::named(rltk::RED), RGB::named(rltk::BLACK));
  }
