...
pub fn remove_item_menu(gs: &mut State, ctx: &mut Rltk) -> (ItemMenuResult, Option<Entity>) {
    ...
    let mut y = (25 - (count / 2)) as i32;
    ctx.draw_box(15, y-2, 32, (count+3) as i32, RGB::named(rltk::WHITE), RGB::named(rltk::BLACK));
...
pub fn game_over(ctx : &mut Rltk) -> GameOverResult {
    ...
    ctx.print_color_centered(18, RGB::named(rltk::WHITE), RGB::named(rltk::BLACK), "That day is not today.");

    ctx.print_color_centered(20, RGB::named(rltk::YELLOW), RGB::named(rltk::BLACK), "Press any key to retrurn to the menu.");
