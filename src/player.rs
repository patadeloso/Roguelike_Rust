use super::{
    ...
    WantsToMelee, WantsToPickupItem, TileType, Monster, HungerClock, HungerState, EntityMoved
};
    ...
    match target_item {
        ...
        Some(item) => {
            ...
            pickup
                ...
                .expect("Unable to insert into pickup");
        }
    }
}
...
pub fn try_next_level(ecs: &mut World) -> bool {
    ...
    if map.tiles[player_idx] == TileType::DownStairs {
        ...
        let mut gamelog = ecs.fetch_mut::<GameLog>();
        gamelog.entries.push("These is no way down from here".to_string());
        false
    }
}
